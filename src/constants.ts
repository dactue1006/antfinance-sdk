...
export const THIRD_PARTY_INFO: { [chainId in ChainId]: any } = {
  ...
  [ChainId.MATIC]: '',
  [ChainId.MATIC_TESTNET]: {
    INIT_CODE_HASH: '0xe18a34eb0e04b04f7a0ac29a6e80748dca96319b42c54d679cb821dca90c6303', // SUSHI
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_TESTNET]: '0x2a26E5D4F067Ef8dfcf73336fBdcBB2a00464BDf',
